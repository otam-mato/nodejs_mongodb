...
> This time I migrate MySQL database to MongoDB database and launch the app on the EC2 instances on the AWS infrastructure created with Terraform.

<br>

**Steps:**
- **Modifying the Terraform template (+ EC2 - RDS)** 
