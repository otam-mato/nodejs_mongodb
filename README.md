...
>
> [!NOTE]
> This is a part of a series of demo projects in which I explore a Node.js application.<br><br>
...
- [**Modify the app code to replace the MySQL database configuration with MongoDB configuration.**](https://github.com/otam-mato/nodejs_mongodb_web_app_terraform/tree/main#3-modifying-the-application-code-to-replace-sql-database-connection-code-with-mongodb-configuration)
